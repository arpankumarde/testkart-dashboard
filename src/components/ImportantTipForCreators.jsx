  ...
  return (
    ...
    <div className="flex flex-col gap-4">
      ...
      <p className="text-[#596780]">
        ...
        provide quality test series. Hence, the teachers are requested to
        put a thumbnail/cover photo for their test series here. The
        thumbnail can include information like the name of the exam, the
        name of the creator/educator and the important bullet points related
        to the test series.
      </p>
    </div>
    <div className="flex flex-col gap-4">
      ...
      <ul className="list-inside  list-decimal text-[#596780] flex flex-col gap-2">
        ...
        <li>
          In the Description dialogue box, you can add details about your
          test series and educate students how they will be helpful in
          building the student's knowledge. It can include all the relevant
          information pertaining to the test series being created by you.
        </li>
        <li>Click on Save & Next.</li>
        <li>
          The Test Series is created successfully and know we have to add
          new tests in the Test Series.
        </li>
        <li>
          Click on View Tests from the additional options available and
          click on Add New Test.
        </li>
        <li>
          Here you can specify the Test Title, the duration and set the
          number of questions for each section of the exam.
        </li>
        <li>
